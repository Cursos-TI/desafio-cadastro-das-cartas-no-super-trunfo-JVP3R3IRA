...
int main()
{
    ...
    superPoder = populacao + area + pib + percapita + ponto_turistico + (1.0 / densidade); // Calcula o super poder da cidade
    ...
    printf("O PIB %s e de: R$ %.2f Bilhoes de reais\n", cidade, pib);

    printf("A cidadde de %s tem %d pontos turisticos\n", cidade, ponto_turistico);

    printf("A densidade populacional e de %f habitantes por km²\n", densidade);

    printf("A renda per capita da cidade de %s e de: R$ %.2f Bilhoes de reais\n", cidade, percapita);
    ...
    printf("Vamos cadastrar mais uma cidades\n\n");
    ...
    superPoder2 = populacao2 + area2 + pib2 + percapita2 + ponto_turistico2 + (1.0 / densidade2); // Calcula o super poder da segunda cidade
    ...
    printf("O Pib da cidade de %s e de: R$ %.2f Bilhoes de reais\n", cidade2, pib2);
    ...
    printf("Vamos para as comparações das cartas\n");
